...
const Player = ()=> {
    return(
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            ...
            <img className='w-4 cursor-pointer' src={assets.playerIcon2} alt="" />
            <img className='w-4 cursor-pointer' src={assets.playerIcon3} alt="" />
            <img className='w-4 cursor-pointer' src={assets.playerIcon4} alt="" />
